  ...
  return (
    <AppShell>
      <div className="space-y-10">
        <PageHeader
          title="使用指南"
          description="从添加员工到发布排班表，跟着下面的步骤走一遍就会用了"
          action={<KangarooMascot variant="badge" animated={false} className="h-14 w-14" />}
        />

        <section className="space-y-5">
          <h2 className="font-display text-lg font-semibold text-ink">快速上手</h2>
            ...
            {STEPS.map((step, i) => (
              <li key={step.title} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < STEPS.length - 1 && <span className="mt-1 w-px flex-1 bg-tan/20" />}
                </div>
        ...
        <section className="space-y-5">
          <h2 className="font-display text-lg font-semibold text-ink">功能详解</h2>
        ...
        <section className="space-y-5">
          <h2 className="font-display text-lg font-semibold text-ink">常见问题</h2>
